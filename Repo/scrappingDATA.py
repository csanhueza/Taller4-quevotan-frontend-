...
baseUri = u"http://opendata.congreso.cl/" #Los datos extraídos están previamente parseados de un xml que ofrece la data de transparencia chilena.

#Datos Cámara Diputados
